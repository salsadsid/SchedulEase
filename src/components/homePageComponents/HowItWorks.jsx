  ...
  return (
    <section className="pt-24 pb-28 bg-white overflow-hidden">
      <div className="container px-4 mx-auto">
        <h2 className="mb-5 text-2xl md:text-4xl text-center font-bold font-heading tracking-px-n leading-tight">
          Your Personal Appointment Scheduler
        </h2>
        <p className="mb-20 text-lg text-gray-900 text-center font-medium md:max-w-lg mx-auto">
          Organize, schedule, and manage your appointments effortlessly.
        </p>
        <div className="flex flex-wrap -m-8">
            ...
            <div className="relative text-center">
              ...
              <div className="md:max-w-xs mx-auto">
                <h3 className="mb-5 font-heading text-xl font-bold font-heading leading-normal">
                  Sign In and Find User
                </h3>
                <p className="font-sans text-gray-600">
                  Easily sign in to your account to access the ScheduleEase
                  dashboard. Your appointments are securely stored and
          ...
          <div className="w-full md:w-1/3 p-8">
            <div className="relative text-center">
              ...
              <div className="md:max-w-xs mx-auto">
                <h3 className="mb-5 font-heading text-xl font-bold font-heading leading-normal">
                  Schedule Appointments from Users Tab
                </h3>
                <p className="font-sans text-gray-600">
                  Create appointments in just a few clicks. Fill in the details
                  like title, description, date, and time, and optionally attach
                  an audio message to personalize your scheduling.
                </p>
              </div>
            </div>
          </div>
          <div className="w-full md:w-1/3 p-8">
            <div className="text-center">
              ...
              <div className="md:max-w-xs mx-auto">
                ...
                <p className="font-sans text-gray-600">
                  View all your appointments at a glance. Keep track of your
                  upcoming and past meetings, and manage them with ease. Cancel
                  or reschedule appointments directly from your dashboard.
                </p>
              </div>
            </div>
          </div>
